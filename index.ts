...
// //     return this.canvas.ratio < this.grid.calcRatio();
// //   }
...
// //       cell_width = this.canvas.width / this.grid.calcWidth();
// //       cell_height = cell_width / this.grid.cell_ratio;
// //     }
// //     //
// //     else {
// //       cell_height = this.canvas.height / this.grid.hei;
...
// //     return this.calcCellSize().height * this.grid.frame.width;
// //   }

// //   calcGridHeight(): number {
// //     return this.calcCellSize().height * this.grid.frame.height;
// //   }
...
// //   _calcOrigin(): { x: number; y: number } {
// //     return { x: this._calcOriginX(), y: this._calcOriginY() };
// //   }

// //   calcPoints(): Array<{ x: number; y: number }> {
